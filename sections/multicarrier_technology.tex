...
\begin{center}
    \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[
            ...
            \node[above=4cm of dummy1, inner sep=0pt, minimum size=0pt] (dummy2) {};
            \node[below=2cm of interp, inner sep=0pt, minimum size=0pt] (dummy_1) {};
            \node[below=4cm of dummy_1, inner sep=0pt, minimum size=0pt] (dummy_2) {};
...
% TODO: perché BT = 1? la banda è 1/T?
