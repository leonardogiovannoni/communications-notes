...
\]
In generale, la dispersione del ritardo di un canale interno è \( \sigma_\tau < 500 \text{ ns} \), il che significa che il canale può essere considerato flat fading, cioè:
\[
T_{OFDM} \gg \sigma_\tau
\]
Assumendo che la mobilità massima interna sia \( v = 3 \text{ m/s} \), la massima deviazione Doppler è:
\[
