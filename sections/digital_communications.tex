...
Nel caso di canale ideale, definendo come $G_{SRRC} = \sqrt{G_{RC}}$ si ottiene:
\[
    g_T(t) = g_{SRRC}(t) \quad \Longleftrightarrow \quad G_T(f) = G_{SRRC}(f) 
\]


\[
    g_R(t) = g_{SRRC}(-t) \quad \Longleftrightarrow \quad G_R(f) = G_{SRRC}^*(f)
\]
